...
const Card = ({ items }) => {
    ...
    return (
        <div className="h-full">
            ...
            >
                <img src={items.img} alt={items.title} className="w-full h-66 object-cover" />
                <div className="p-4 flex-grow">
                    ...
                    <p className="text-gray-600 mb-2">{items.price}</p>
                    <p className="text-gray-600">Size: {items.size}</p>
                </div>
                {items.new && (
